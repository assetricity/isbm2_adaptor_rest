...
module IsbmRestAdaptor
  class ContentFilteringLanguage
    ...
    def list_invalid_properties
      ...
      if @applicable_media_types.nil?
        invalid_properties.push('invalid value for "applicable_media_types", applicable_media_types cannot be nil.')
      end
    ...
    def valid?
      return false if @applicable_media_types.nil?
    ...
    def hash
      [applicable_media_types, language_name, language_version].hash
    end
