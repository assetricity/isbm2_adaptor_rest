...
# Note: includes customised deserialization to handle the OneOf content, since the generated handling
...
module IsbmRestAdaptor
  class MessageContent
    ...
    def self.openapi_types
      {
        ...
        # below has been customised as the generated handling appears broken, see also: #_deserialize
        :'content' => :'OneOf[String, Object]'
      }
    end
    ...
    def hash
      [media_type, content_encoding, content].hash
    end
    ...
    def _deserialize(type, value)
      ...
      when /\AOneOf\[(?<type_list>.+?)\]\z/
        # customised handling for OneOf, since the generated handling appears broken
        type_list = Regexp.last_match[:type_list].split(/,\s*/)
        new_value = nil
        matched_type = type_list.detect do |t|
          new_value = _deserialize(t, value)
