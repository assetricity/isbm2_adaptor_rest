...
# Unit tests for ISBMRestAdaptor::ProviderRequestServiceApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ProviderRequestServiceApi' do
  before do
    # run before each test
    @instance = ISBMRestAdaptor::ProviderRequestServiceApi.new
  end
  ...
  describe 'test an instance of ProviderRequestServiceApi' do
    it 'should create an instance of ProviderRequestServiceApi' do
      expect(@instance).to be_instance_of(ISBMRestAdaptor::ProviderRequestServiceApi)
    end
  end
  ...
  # unit tests for open_provider_request_session
  ...
  # @param [Hash] opts the optional parameters
  # @option opts [Session] :session The configuration of the session, i.e., topic filtering, content-filtering, and notication listener address
  # @return [Session]
  describe 'open_provider_request_session test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for post_response
  ...
  # @return [Message]
  describe 'post_response test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for read_request
